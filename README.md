...
The airflow-component solution is a reference deployment architecture for apache airflow, designed to accelerate deployment of a federated, multi-tenant implemenation using Configuration as Code.
